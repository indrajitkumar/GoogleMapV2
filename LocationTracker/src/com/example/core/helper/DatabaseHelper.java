...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void insertValueOnTransfer(String key, String value) {
		LogUtils.v("Inserting " + key + "|" + value);
		SQLiteDatabase db = getWritableDatabase();

		// SQLiteDatabase.openDatabase(path, factory, flags);
		String insert_value = resources.getString(R.string.insert_value_onTransfer);
		String[] args = new String[] { key, value };
		db.execSQL(insert_value, args);
		db.close();
	}
...
//
//		// SQLiteDatabase.openDatabase(path, factory, flags);
//		String delete_value = resources.getString(R.string.delete_value);
//		String[] args = new String[] { key, value };
//		db.execSQL(delete_value, args);
//		db.close();
//	}
